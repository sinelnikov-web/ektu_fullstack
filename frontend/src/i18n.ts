...
const resources = {
    ...
    kk: {
        translation: {
            ...
            "При нажатии на эту кнопку, откроется виджет с нашим Instagram": "Осы батырманы басқан кезде виджет Біздің Instagram-да ашылады",
            ...
            "Это поиск по сайту. При нажатии на него, откроется поиск с помощью которого Вы легко сможете найти нужный контент на сайте.": "Бұл сайтты іздеу. Сіз оны басқан кезде сайтта қажетті мазмұнды оңай табуға болатын іздеу ашылады.",
        }
    }
};
